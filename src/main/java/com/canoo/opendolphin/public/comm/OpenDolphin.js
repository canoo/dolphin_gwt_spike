define(["require", "exports", '../../js/dolphin/ClientDolphin', '../../js/dolphin/ClientModelStore', '../../js/dolphin/ClientConnector', '../../js/dolphin/NoTransmitter', '../../js/dolphin/HttpTransmitter'], function(require, exports, dol, mst, cc, ntm, htm) {
    /**
